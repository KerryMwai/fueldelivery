...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyNavPage(title: 'Animated Navigation Bottom Bar'),
    );
  }
}

class MyNavPage extends StatefulWidget {
  MyNavPage({Key? key, required this.title}) : super(key: key);
...
class _MyNavPageState extends State<MyNavPage> with TickerProviderStateMixin {
